...
// the following define statements are used for graphical representation
...
public:
  ...
  void movePiece(pair <int, int> start, pair <int, int> end, string cell);
  bool isValidMove(PLAYER currPlayer, pair <int, int> start, pair<int, int> end, string token);
  bool validateJump(pair <int, int> begin, pair <int, int> finish, string piece);
